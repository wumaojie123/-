...
<template>
  <div class="content-area bd-manage">
    ...
    <el-form ref="baseInfoRef" :model="baseInfo" :rules="rules" status-icon label-width="150px" label-position="left" style="margin-top: 20px;">
      ...
      <div style="padding-bottom: 35px;border-bottom: 1px solid #F0F0F0;">
        <span>总额</span>
        <span style="position: relative;">
          <el-input v-model="baseInfo.total" disabled style="margin-right: 28px;margin-left: 118px;width: 150px;" />
          <span style="position: absolute;left: 118px;top: 2px;color: #c0c4cc;">￥</span>
        </span>
        <span>余额</span>
        <span style="position: relative;">
          <el-input v-model="baseInfo.balance" disabled style="margin-left: 5px;width: 150px;" />
          <span style="position: absolute;left: 5px;top: 2px;color: #c0c4cc;">￥</span>
        </span>
      </div>
      ...
      <el-form-item label="广告分成最小上线数" prop="minEquipmentCount">
        <el-input v-model="baseInfo.minEquipmentCount" placeholder="请输入广告分成最小上线数" style="width: 370px;" />
      </el-form-item>
