    ...
    handlePage(type) {
      if (this.selectItems.length === 1) {
        ...
        if (type === 1) {
          ...
          this.$router.push({ path: '/deviceServiceEdit', query: { value: this.selectItems[0].value, lyyEquipmentId: this.selectItems[0].lyyEquipmentId, equipmentType: this.queryParams.equipmentType, communication: this.selectItems[0].communication, name: data.distributor, phoneNumber: data.account }})
        } else if (type === 3) {
