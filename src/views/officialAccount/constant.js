...
export const mapInfo = {
  XYJ: [
    [
      ...
      { title: '我的洗衣订单', desc: '顾客可在公众号菜单查看洗衣剩余时长、余额、设备在线状态等信息', url: 'pages/wash-order.html', label: 2 }
    ],
  ...
  CDZ: [
    [
      ...
      { title: '我的充电订单', desc: '顾客可在公众号菜单查看充电剩余时长、余额、设备在线状态等信息', url: 'pages/charge-order.html', label: 2 }
    ],
    { title: '商户管理平台', desc: '商家可在公众号菜单进入私有化商户管理平台', url: 'https://b.leyaoyao.com/group/index.html', label: 3 },
